...
<%if(request.getParameter("submit") != null){%>
    ...
    AcctController.updateEmp(user, pass, email, newEmail, telephone, first, last, address, city, Integer.parseInt(zip), state, role, Double.parseDouble(rate), Integer.parseInt(ssn));
...
<%}%>
            ...
            <head>
                ...
                <title>Update Existing Employee</title>
                <!-- Bootstrap core CSS -->
